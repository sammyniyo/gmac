...
return [
    ...
    /*
     * Top-level folder inside the public disk for organized uploads (hero-slide, products, …).
     */
    'gmac_upload_root' => env('MEDIA_UPLOAD_ROOT', 'uploads'),
     ...
     */
    'path_generator' => App\Support\MediaLibrary\GmacPathGenerator::class,
     ...
     */
    'url_generator' => App\Support\MediaLibrary\RequestAwareUrlGenerator::class,
